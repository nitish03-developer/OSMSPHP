...
<!-- End 2nd Column -->
  ...
  if(isset($_REQUEST['assign']))
  {
    ...
    || ($_REQUEST['inputDate'] == ""))
    {
      $msg = '<div class="alert alter-warning col-sm-6 ml-5 mt-2">Fill all Fields</div>';
    }
    else
    {
       ...
       request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, assign_tech, assign_date)
       VALUES ('$rid', '$rinfo', '$rdesc', '$rname','$radd1','$radd2','$rcity','$rstate','$rzip','$remail','$rmobile','$rassigntech','$rdate')";
       if($conn->query($sql) == TRUE)
       {
        $msg = '<div class="alert alter-warning col-sm-6 ml-5 mt-2">Work Assigned Successfully</div>';
       }
       else{
        $msg = '<div class="alert alter-danger col-sm-6 ml-5 mt-2">unamble to Asign Work</div>';
       }
    }
  }
  ?>
